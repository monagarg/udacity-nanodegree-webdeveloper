...
#Listings
listing1 = Listing(deposit = "20", max_days = "20", user = user1, product = product1)

session.add(listing1)
session.commit()

listing2 = Listing(deposit = "30", max_days = "30", user = user1, product = product2)

session.add(listing2)
session.commit()

listing3 = Listing(deposit = "40", max_days = "40", user = user1, product = product3)

session.add(listing3)
session.commit()

listing4 = Listing(deposit = "25", max_days = "25", user = user2, product = product4)

session.add(listing4)
session.commit()

listing5 = Listing(deposit = "35", max_days = "35", user = user2, product = product5)

session.add(listing5)
session.commit()

listing6 = Listing(deposit = "45", max_days = "45", user = user2, product = product6)
